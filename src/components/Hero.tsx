...
import { Download, DownloadIcon, MapPin } from "lucide-react";
  ...
  return (
    <section className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-gradient-hero">
      ...
      <div className="absolute top-0 right-0 w-full h-full opacity-60 pointer-events-none">
        <Globe className="top-0 max-w-[420px] md:max-w-[700px]" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        <div className="animate-fade-in">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/10 border border-accent/20 mb-6 ">
            ...
            <span className="text-sm font-medium text-accent-foreground">Live GPS Tracking Technology</span>
          </div>
          ...
          <div className="flex justify-center items-center">
            ...
            >
                <a href="/app-release.apk" download="BusTracker.apk" className="flex items-center">
